...
allprojects {
    ...
    plugins.withType(com.android.build.gradle.FeaturePlugin::class).configureEach {
        setBaseAndroidConfiguration(extensions.getByName("android") as BaseExtension)
    }
    plugins.withType(com.android.build.gradle.DynamicFeaturePlugin::class).configureEach {
        setBaseAndroidConfiguration(extensions.getByName("android") as BaseExtension)
    }
    plugins.withType(com.android.build.gradle.InstantAppPlugin::class).configureEach {
        setBaseAndroidConfiguration(extensions.getByName("android") as BaseExtension)
    }
}
