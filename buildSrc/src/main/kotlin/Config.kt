...
object Config {
    ...
    object Libs {
        ...
        object WebFrontend {
            ...
            const val kotlinReact = "org.jetbrains:kotlin-react:16.9.0-pre.88-kotlin-1.3.60"
            const val kotlinReactDom = "org.jetbrains:kotlin-react-dom:16.9.0-pre.88-kotlin-1.3.60"
            const val kotlinReactRouterDom =
                "org.jetbrains:kotlin-react-router-dom:4.3.1-pre.88-kotlin-1.3.60"
        }
        ...
        object Aws {
            const val sdkBom = "software.amazon.awssdk:bom:2.10.25"
