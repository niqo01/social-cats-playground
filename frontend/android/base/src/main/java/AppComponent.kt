...
import com.nicolasmilliard.socialcats.session.InstanceIdProvider
...
object AppModule {
    ...
    fun provideSessionManager(auth: Auth, store: SocialCatsStore, instanceIdProvider: InstanceIdProvider) =
        SessionManager(auth, store, instanceIdProvider)
