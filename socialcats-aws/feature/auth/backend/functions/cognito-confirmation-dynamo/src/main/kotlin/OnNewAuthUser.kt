...
import com.nicolasmilliard.socialcatsaws.profile.ProfileUseCaseModule
...
fun UserAttributes.toUser() = User(sub, cognitoEmailAlias, email_verified.toBoolean())
