...
object Config {
    const val kotlinVersion = "1.4.10" // update gradle.properties as well
    ...
    object Android {
        ...
        const val navigationVersion = "2.3.1" // Update gradle.properties as well
    ...
    object Libs {
        ...
        object Ktor {
            private const val ktorVersion = "1.4.1"
        ...
        object Play {
            ...
            const val billing = "com.android.billingclient:billing-ktx:3.0.1"
        }

        object Firebase {

            const val admin = "com.google.firebase:firebase-admin:7.0.1"

            const val common = "com.google.firebase:firebase-common-ktx:19.3.1"
            const val auth = "com.google.firebase:firebase-auth-ktx:20.0.0"
            ...
            const val performance = "com.google.firebase:firebase-perf:19.0.9"
            ...
            const val inAppMessaging = "com.google.firebase:firebase-inappmessaging-display-ktx:19.1.2"

            const val uiAuth = "com.firebaseui:firebase-ui-auth:6.4.0"
        ...
        object Aws {
            const val sdkBom = "software.amazon.awssdk:bom:2.15.17"
        ...
        // Misc
        const val statelyIsolate = "co.touchlab:stately-isolate:1.1.1-a1"
        const val statelyIsoCollections = "co.touchlab:stately-iso-collections:1.1.1-a1"
        ...
        const val guavaAndroid = "com.google.guava:guava:30.0-android"
        ...
        object Stripe {
            const val java = "com.stripe:stripe-java:20.24.0"
            const val android = "com.stripe:stripe-android:16.0.1"
        }

        object GoogleCloud {
            const val tasks = "com.google.cloud:google-cloud-tasks:1.30.6"
            const val loggingLogback = "com.google.cloud:google-cloud-logging-logback:0.118.4-alpha"
