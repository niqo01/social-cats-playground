...
val productId = "prod_HSEdze05oGlQmH"

class StripePayments(private val paymentProcessor: PaymentProcessor, private val store: UserStoreAdmin) {
    ...
    suspend fun createCheckoutSession(uId: String): CreateCheckoutSessionResult {
        ...
        val checkoutUrl = paymentProcessor.createCheckoutSession(customerId, productId, US_CURRENCY, 300L)
        return CreateCheckoutSessionResult(checkoutUrl)
    }
