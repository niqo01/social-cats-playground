...
import com.nicolasmilliard.socialcats.featureflags.FeatureFlag
...
import com.nicolasmilliard.socialcats.testsettings.databinding.FragmentFeatureflagBinding

internal class FeatureSelectFragment : androidx.fragment.app.Fragment() {

    private var binding: FragmentFeatureflagBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentFeatureflagBinding.inflate(inflater, container, false)
        return binding!!.root
    }
    ...
    private fun initializeRecyclerView() {
        val runtimeFeatureFlagProvider = RuntimeFeatureFlagProvider(MEDIUM_PRIORITY, requireContext())
